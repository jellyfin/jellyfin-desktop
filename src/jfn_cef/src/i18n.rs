...
fn en_us(key: StringKey) -> &'static str {
    match key {
        ...
        StringKey::AboutJellyfinDesktop => "About Jellium Desktop",
        ...
        StringKey::HideJellyfinDesktop => "Hide Jellium Desktop",
...
fn zh_cn(key: StringKey) -> &'static str {
    match key {
        ...
        StringKey::AboutJellyfinDesktop => "关于 Jellium Desktop",
        ...
        StringKey::HideJellyfinDesktop => "隐藏 Jellium Desktop",
...
fn zh_tw(key: StringKey) -> &'static str {
    match key {
        ...
        StringKey::AboutJellyfinDesktop => "關於 Jellium Desktop",
        ...
        StringKey::HideJellyfinDesktop => "隱藏 Jellium Desktop",
