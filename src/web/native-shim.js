    ...
    window.jmpInfo = {
        ...
        settingsDescriptions: {
            ...
            advanced: [
                ...
                { key: 'customMpvConfig', displayName: 'Custom MPV Configuration', help: 'Configuration must be supplied in the same format as mpv.conf. E.g. \"video-rotate=90\"', inputType: 'textarea', rows: 8 }
            ]
        },
        settingsUpdate: [],
