...
- [AppImage](https://nightly.link/jellyfin-labs/jellyfin-desktop/workflows/build-linux-appimage/main/linux-appimage-x86_64.zip)
- Arch Linux (AUR): [jellyfin-desktop-git](https://aur.archlinux.org/packages/jellyfin-desktop-git)
- [Flatpak (non-Flathub bundle)](https://nightly.link/jellyfin-labs/jellyfin-desktop/workflows/build-linux-flatpak/main/linux-flatpak.zip)

### macOS
- [Apple Silicon](https://nightly.link/jellyfin-labs/jellyfin-desktop/workflows/build-macos/main/macos-arm64.zip)
...
### Windows
- [x64](https://nightly.link/jellyfin-labs/jellyfin-desktop/workflows/build-windows/main/windows-x64.zip)
- [arm64](https://nightly.link/jellyfin-labs/jellyfin-desktop/workflows/build-windows/main/windows-arm64.zip)
